...
<head>
    ...
    <title>Tạo mã giảm giá riêng</title>
...
<body id="page-top">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <form action="{{ route('private-coupons.store') }}" method="POST">
                        @csrf
                        <div class="row">
                            <div class="col-lg-8">
                                <!-- Basic Information -->
                            ...
                            <div class="col-lg-4">
                                ...
                                <div class="preview-card">
                                    ...
                                    <div class="preview-code" id="preview-code">NHUTLINH2025</div>
                                    <div class="mt-3">
                                ...
                                <div class="card shadow mt-3">
                                    <div class="card-body">
                                        ...
                                        <button type="submit" class="btn btn-primary btn-block">
                                            <i class="fas fa-save mr-2"></i>Tạo mã giảm giá
                                        </button>
    ...
    <script>
        ...
        function updatePreview() {
            const code = document.getElementById('code').value || 'NHUTLINH2025';
