                    ...
                    <div class="row" style="justify-content: center;">
                        <div class="col-lg-8">
                            <div class="p-5">
                                ...
                                @endphp
                                <form class="user" action="{{route('manage_subcategory_edits')}}" method="POST" enctype="multipart/form-data" id="manage_category_edits">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="categoryName"
                                            placeholder="Nhập tên danh mục " name="categoryName" value="{{$categoryName->categoryName }}" disabled>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="categoryName"
                                            placeholder="Nhập tên danh mục phụ" name="subCategoryName" value="{{$subcategory->subCategoryName }}">
                                    </div>
