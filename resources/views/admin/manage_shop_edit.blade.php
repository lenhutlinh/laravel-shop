                    ...
                    <div class="row" style="justify-content: center;">
                        <div class="col-lg-8">
                            <div class="p-5">
                                ...
                                @endphp
                                <form class="user" action="{{route('manage_shop_edits')}}" method="POST" enctype="multipart/form-data" id="manage_shop_edits">
                                    @csrf
                                    <input type="hidden" name="id" value="{{$shop->id}}">
                                    
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" id="exampleInputEmail"
                                            placeholder="Địa Chỉ Email " name="email" value="{{$shop->email }}"disabled>
                                    </div>
