                    ...
                    <div class="rhmIbk">
                        <div class="stardust-dropdown stardust-dropdown--open">
                            <div class="stardust-dropdown__item-header">
                                <a class="+1U02e wkLUkx" href="{{route('user_account')}}">
                                    <div class="bfikuD">
                        ...
                        <div class="stardust-dropdown ">
                            <div class="stardust-dropdown__item-header">
                                <a class="+1U02e " href="{{route('user_purchase')}}">
                                    <div class="bfikuD">
                ...
                <div class="xMDeox">
                    <div class="Hvae38" role="main">
                        ...
                        <div class="b7wtmP">
                            ...
                            @endphp
                            <form action="{{route('change_profile_user')}}" method="POST" enctype="multipart/form-data" id="form_post">
                                @csrf
                            <div class="R-Gpdg">
                                <div class="volt8A">
                                    <table class="Zj7UK+">
                                        <tr>
                                            ...
                                            <td class="Tmj5Z6">
                                                <div>
                                                    <div class="W50dp5">
                                                        <input type="text" placeholder="" class="CMyrTJ" value="{{$user->firstname}}" name="first_name">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="Tmj5Z6">
                                                <div>
                                                    <div class="W50dp5">
                                                        <input type="text" placeholder="" class="CMyrTJ" value="{{$user->lastname}}" name="last_name">
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td class="Tmj5Z6">
                                                <div class="W50dp5">
                                                    <input type="email" placeholder="" class="CMyrTJ" value="{{$user->email}}" name="email">
                                                </div>
                                            </td>
                                        </tr>
                                ...
                                <div class="IQPHvE">
                                    <div class="scvgOW">
                                        <div class="XWsmVn">
                                            @if(Session::get('user_img') != null)
                                            <div class="LoNm4g" style="background-image: url(&quot;{{asset('storage/'.$user_img)}}&quot;);"></div>
                                            @else
                                            <div class="LoNm4g" style="background-image: url(&quot;{{asset('storage/users_img/user.png')}}&quot;);"></div>
                                            @endif
                                        </div>
