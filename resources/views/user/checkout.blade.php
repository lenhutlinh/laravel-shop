        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <select class="form-control choose_coupon" data-total_price="{{$total_price}}">
                ...
                <div class="modal-footer row" >
                    ...
                    <span class="btn btn-primary col-3" id="import_coupon" data-total_price="{{$total_price}}">Dùng Mã </span>
                </div>
            </div>
            </form>
        </div>
