                            ...
                            <div class="table-right-info-item">
                                <div class="table-left-info-product">
                                    <div class="table-left-info-img">
                                        <img id="table-left-info-img" src="{{asset('storage/'.$product_buy->previewImage)}}" alt="">
                                    </div>
                                    <div class="table-left-info-product-pro">
                                        ...
                                        <div class="table-left-info-product-price">
                                            <strong id="table-left-info-product-price">{{number_format($product_buy->price, 0, ',', '.') }} </strong>
                        ...
                        <div class="table-right-info" >
                            <div class="table-right-info-price-product">
                                <div id="table-right-info-price-product">
                                    <span>Tiền hàng</span>
                                    <span style="font-weight: 700;" id="price_order" >{{number_format($total_price, 0, ',', '.')}}đ</span>
                                </div>
                                <div id="table-right-info-price-product">
                                    <span>Phí ship</span>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-footer row" >
                    ...
                    <span class="btn btn-primary col-3" id="import_coupon_now" data-total_price="{{$total_price}}">Dùng Mã </span>
                </div>
            </div>
            </form>
        </div>
