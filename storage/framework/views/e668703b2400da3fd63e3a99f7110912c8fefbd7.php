                        ...
                        <div class="col-lg-8">
                            <div class="p-5">
                                <div class="text-center">
                                    <h1 class="h4 text-gray-900 mb-4">Đổi mật khẩu tài khoản nguời dùng</h1>
                                </div>
                                <?php
                                ...
                                ?>
                                <form class="user" action="<?php echo e(route('manage_users_edits')); ?>" method="POST" enctype="multipart/form-data" id="manage_user_edits">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="id" value="<?php echo e($user->id); ?>">
                                    
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" id="exampleInputEmail"
                                            placeholder="Địa Chỉ Email " name="email" value="<?php echo e($user->email); ?>"disabled>
                                    </div>
...
</html><?php /**PATH D:\Ecommerce\resources\views/admin/manage_users_edit.blade.php ENDPATH**/ ?>