                  ...
                  <div class="card" style="border-radius: 15px;">
                    <div class="card-body p-5">
                      ...
                      <form action="<?php echo e(route('login_user')); ?>" method="POST">
                        ...
                        <p class="text-center text-muted mt-5 mb-0">Bạn chưa có tài khoản? <a href="<?php echo e(route('registers')); ?>" class="fw-bold text-infor" style="text-decoration: none;">Đăng ký tại đây</a></p>
...
<?php /**PATH D:\Ecommerce\resources\views/user/login.blade.php ENDPATH**/ ?>