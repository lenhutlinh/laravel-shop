            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- First Column -->
                    <form action="<?php echo e(route('shop_add_products')); ?>" method="GET" enctype="multipart/form-data" id="form_add_product">
                        <?php echo csrf_field(); ?>
                        <div class="col-lg-10"> 
...
</html><?php /**PATH D:\Ecommerce\resources\views/shop/add_product.blade.php ENDPATH**/ ?>