                    ...
                    <div class="xMDeox">
                        <div class="Hvae38" role="main">
                            ...
                            <div class="b7wtmP">
                                ...
                                ?>
                                <form action="<?php echo e(route('change_password_shop')); ?>" method="POST" enctype="multipart/form-data" id="form_post">
                                    <?php echo csrf_field(); ?>
                                <div class="R-Gpdg">
                                    <div class="volt8A">
                                        <table class="Zj7UK+">
...
</html><?php /**PATH D:\Ecommerce\resources\views/shop/shop_password.blade.php ENDPATH**/ ?>