    ...
    <div id="wrapper">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <!-- Begin Page Content -->
            <form action="<?php echo e(route('update_product')); ?>" method="POST" enctype="multipart/form-data" id="edit_quantity_product">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="card-body">
                            ...
                            <div class="add_product_info" style="display: flex;">
                                    <div class="add_product_info_t">
                                        ...
                                        <input  type="text" value="<?php echo e($product->productName); ?>" name="product_name" id="product_name" class="product_name" placeholder="Nhập tên sản phẩm" required>
                                    </div>
                                    <div class="add_product_info" style="display: flex;">
                                        <div class="add_product_info_t">
                                            <p class="text-gray-900 p-3 m-0" >Giá sản phẩm</p>
                                        </div>
                                        <input  type="number" value="<?php echo e($product->price); ?>" min="1" max="999999999"  name="product_price" id="product_price" class="product_name number_cart" placeholder="Nhập giá sản phẩm" required>
                                    </div>
                                    <div class="add_product_info" style="display: flex;">
                                        <div class="add_product_info_t">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" id="dataTable"  cellspacing="0">
                                    ...
                                    <tbody>
                                        <?php $__currentLoopData = $combination_string; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $combination): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <tr>
                                            <td>
                                                <?php echo e($combination->combination_string); ?>

                                            </td>
                
                                            <td>
                                                <input id="avaiable_stock" required name='avaiable_stock[]'  type="number" class="form-control form-control-sm" min="1" value="<?php echo e($combination->avaiable_stock); ?>" max="10000" aria-controls="dataTable">
                                            </td>
                                        </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </tbody>
...
<script type="text/javascript">
    $(document).ready(function(){
        $('.choose_category').on('change',function(){
            ...
            $.ajax({
                url: '<?php echo e(route('select_category')); ?>',
                method: 'GET',
...
</html><?php /**PATH D:\Ecommerce\resources\views/shop/edit_product.blade.php ENDPATH**/ ?>