                ...
                <div class="AmWkJQ">
                    ...
                    <div class="rhmIbk">
                        ...
                        <div class="stardust-dropdown stardust-dropdown--open">
                            <div class="stardust-dropdown__item-header">
                                <a class="+1U02e wkLUkx" href="<?php echo e(route('user_purchase')); ?>">
                                    <div class="bfikuD">
                                ...
                                <div class="hiXKxx">
                                                ...
                                                <div class="qCUYY8">
                                                    <div>
                                                        <div class="cart-table-left-shop-img">
                                                            <a href="<?php echo e(route('view_shop',$order -> shop_id)); ?>">
                                                                <img id="cart-table-left-shop-img" src="<?php echo e(asset('storage/'.$order->shopImg )); ?>" alt="">
                                                            </a>    
                                                        </div>
                                                    </div>
                                                    <div class="_9Ro5mP"><?php echo e($order->shopname); ?> </div>
                                                    <a class="yHlRfY" href="<?php echo e(route('show_chat',$order -> shop_id)); ?>">
                                                    ...
                                                    <a class="_7wKGws" href="<?php echo e(route('view_shop',$order -> shop_id)); ?>">
                                                        ...
                                                        <div>
                                                            <span class="x7nENX">
                                                                    ...
                                                                    <div class="rGP9Yd">
                                                                        <div class="shopee-image__wrapper">
                                                                            ...
                                                                            <a href="<?php echo e(route('detail_product',$product -> product_id)); ?>">
                                                                                <img class="shopee-image__content" style="background-image: url(<?php echo e(asset('storage/'.$product->previewImage)); ?>);">
                                                                            </a>
                                                                ...
                                                                <div class="_7uZf6Q">
                                                                    <div>
                                                                        <div class="iJlxsT">
                                                                            <span class="x5GTyN"><?php echo e($product->product_name); ?></span>
                                                                        </div>
                                                                    </div>
                                                                    <?php if($product->product_combination != null): ?>
                                                                    <div>
                                                                        <div class="vb0b-P">Phân loại hàng: <?php echo e($product->product_combination); ?></div>
                                                                        <div class="_3F1-5M">x<?php echo e($product->product_quantity); ?></div>
                                                            ...
                                                            <div class="_9UJGhr"><div>
                                                                ...
                                                                <span class="-x3Dqh OkfGBc"><?php echo e(number_format($product->product_price, 0, ',', '.')); ?>₫</span>
                                                            </div>
                                                        </div>
                                                    </span>
                                                </div>
                                    ...
                                    <div class="kvXy0c">
                                        <div class="-78s2g">
                                            ...
                                            <div class="DeWpya"><?php echo e(number_format($order->order_total, 0, ',', '.')); ?>₫</div>
                                        </div>
                                    </div>
                                    <?php if($order->order_status == 0): ?>
                                    <div class="AM4Cxf">
                                        ...
                                        <div class="EOjXew">
                                            <div class="PF0-AU">
                                                <button   data-order_id="<?php echo e($order->id); ?>"  class="stardust-button stardust-button--primary WgYvse user_cancel_order">Hủy Đơn Hàng</button>
                                            </div>
...
<?php /**PATH D:\Ecommerce\resources\views/user/purchase.blade.php ENDPATH**/ ?>