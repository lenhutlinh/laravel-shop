    ...
    <main >
       <div class="checkout-center">
            <div class="page-checkout">
                ...
                <form method="POST" action="<?php echo e(route('order')); ?>" class="checkout-table" id="form-checkout">
                    <?php echo csrf_field(); ?>
                            ...
                            <div class="table-right-info-item">
                                <div class="table-left-info-product">
                                    <div class="table-left-info-img">
                                        <img id="table-left-info-img" src="<?php echo e(asset('storage/'.$product->product_image)); ?>" alt="">
                                    </div>
                                    <div class="table-left-info-product-pro">
                                        ...
                                        <div class="table-left-info-product-price">
                                            <strong id="table-left-info-product-price"><?php echo e(number_format($product->product_price, 0, ',', '.')); ?> </strong>
                                            <span class="">x <?php echo e($product->quantity); ?></span>
                                        </div>
                                    </div>
                                </div>
                                <div class="table-right-info-product-var">
                                    <span id="table-left-info-product-var" ::><?php echo e($product->combination); ?></span>
                        ...
                        <div class="table-right-info">
                            <div class="table-right-info-price-product">
                                <div id="table-right-info-price-product">
                                    <span>Tiền hàng</span>
                                    <span style="font-weight: 700;"><?php echo e(number_format($total_price, 0, ',', '.')); ?>đ</span>
                                </div>
                                <div id="table-right-info-price-product">
                                    <span>Phí ship</span>
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <select class="form-control choose_coupon" data-total_price="<?php echo e($total_price); ?>">
                ...
                <div class="modal-footer row" >
                    ...
                    <span class="btn btn-primary col-3" id="import_coupon" data-total_price="<?php echo e($total_price); ?>">Dùng Mã </span>
                </div>
            </div>
            </form>
        </div>
...
<?php echo $__env->make('user.ajax_checkout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Ecommerce\resources\views/user/checkout.blade.php ENDPATH**/ ?>