                    ...
                    <div class="row" style="justify-content: center;">
                        <div class="col-lg-8">
                            <div class="p-5">
                                ...
                                ?>
                                <form class="user" action="<?php echo e(route('manage_category_edits')); ?>" method="POST" enctype="multipart/form-data" id="manage_category_edits">
                                    <?php echo csrf_field(); ?>
                                    <input type="hidden" name="id" value="<?php echo e($category->id); ?>">
                                    
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="categoryName"
                                            placeholder="Nhập tên danh mục " name="categoryName" value="<?php echo e($category->categoryName); ?>">
                                    </div>
                                    <!-- <img src="<?php echo e(asset('storage/'.$category->categoryIcon)); ?>" style="height:100px; widght:auto;"/> -->
                                    <div class="form-group" id="uploadfile">
                                        <input type="file" class="form-control-file" id="default-btn" name="categoryIcon" value="<?php echo e($category->categoryIcon); ?>">
...
</html><?php /**PATH D:\Ecommerce\resources\views/admin/manage_category_edit.blade.php ENDPATH**/ ?>